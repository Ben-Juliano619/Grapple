...
const shouldBypassImageOptimization = process.env.NODE_ENV !== "production";
    ...
    <div className="game-page mobile-safe-page">
      ...
      <section className="draw-area">
        <div className="draw-layout">
          ...
          >
            <Image src={BACK_OF_CARD} alt="Draw pile" width={190} height={272} sizes="(max-width: 767px) 50vw, 190px" quality={60} unoptimized={shouldBypassImageOptimization} priority style={{ width: "100%", height: "auto", borderRadius: 8 }} />
